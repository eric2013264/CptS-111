...
#			all_sprites_list.remove(bullet)
	...
	if bullet.y < 479 and bullet.y > 0: 
		bullet.render()
		bullet.y -= 10     				# subtract 5 from vertical as missile moves up screeen # renders bullet # our missile
	...
	for count in range(0, len(enemies)):
		if Intersect(bullet.x, bullet.y, enemies[count].x, enemies[count].y):
	...
	for count in range(0, len(enemies_2)):
		if Intersect(bullet.x, bullet.y, enemies_2[count].x, enemies_2[count].y):
			del enemies_2[count]
			bullet.x = 0
			bullet.y = 480
			score += 1
	...
	if Intersect(bullet.x, bullet.y, shield.x, shield.y):
		if shield_1_life > 0:
			shield_1_life -= 1
			bullet.x = 0
			bullet.y = 480
	...
	if Intersect(bullet.x, bullet.y, shield_2.x, shield_2.y):
		...
		if shield_2_life == 0:
			...
			shield_2.y = 480
			bullet.x = 0
			bullet.y = 480 # if we hit shield 2
	...
	if Intersect(bullet.x, bullet.y, shield_3.x, shield_3.y):
		...
		if shield_3_life == 0:
			...
			shield_3.y = 480			
			bullet.x = 0
			bullet.y = 480# if we hit shield 3
